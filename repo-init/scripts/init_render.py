...
def _build_readme_contract_sections(mode: str, intake: dict[str, Any], summary: dict[str, Any], heading: str) -> list[str]:
    ...
    lines = [
        ...
        *_initialization_model_lines(mode, intake),
        ...
        "- `REUSE.md` defines when technical planning must search for open-source reuse or adaptation candidates.",
        ...
        "- `REUSE.md` explains the open-source reuse gate for technical planning.",
...
def render_agent(mode: str, intake: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "- Check `REUSE.md` before proposing a technical approach for reusable or non-trivial capabilities.",
        "- Record open-source reuse candidates, risks, and the final decision in the relevant task before implementation starts.",
...
def render_reuse() -> str:
    """Render REUSE.md content."""
    return "\n".join(
        [
            "# REUSE.md",
            "",
