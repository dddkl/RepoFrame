...
export default function App() {
  ...
  const [addingProductField, setAddingProductField] = useState(false);
        ...
        >
                  ...
                  {page === "start" ? (
                      ...
                      <div className="flex flex-col gap-7">
                        <Card>
                          ...
                          <CardContent className="flex flex-col gap-6">
                            {snapshot.product ? (
                              <ProductFields product={snapshot.product.data} />
                            ) : (
                              <Empty>
                                <EmptyHeader>
                    ...
                    <>
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <h1 className="break-words">{detail.data.title}</h1>
                      ...
                      <div className="grid items-start gap-6 lg:grid-cols-2">
                        <Card>
                          ...
                          <CardContent>
                            <Lines items={detail.data.doneWhen} numbered />
                          </CardContent>
                          <CardFooter>
                            <span className="text-xs text-muted-foreground">
                              共 {detail.data.doneWhen.length} 条完成条件
                            </span>
                          </CardFooter>
                        </Card>
                        <Card>
                      ...
                      <Card>
                        <CardHeader>
                          ...
                          <CardDescription>
                            保留已完成的工作和验证，让下次执行可以恢复。
                          </CardDescription>
                        </CardHeader>
                        <CardContent>
                          {detail.data.progress.length ? (
                            <Lines items={detail.data.progress} numbered />
                          ) : (
                            <Empty>
                              <EmptyHeader>
                    ...
                    <>
                      ...
                      <div className="flex flex-col gap-4">
                        {snapshot.goals.filter((g) => g.data.status === filter)
                          .length ? (
                          snapshot.goals
                            ...
                            .map((goal) => (
                              <Card key={goal.id}>
                                ...
                                <CardContent>
                                  <p className="text-xs text-muted-foreground">
                                    {goal.data.doneWhen.length} 条完成条件{" "}
                                    <span className="mx-2">·</span>{" "}
                                    {goal.data.progress.length} 条进展记录
                                  </p>
                                </CardContent>
          ...
          {snapshot && productEditor && (
            <ProductEditor
              ...
              startAdding={addingProductField}
              snapshot={snapshot}
